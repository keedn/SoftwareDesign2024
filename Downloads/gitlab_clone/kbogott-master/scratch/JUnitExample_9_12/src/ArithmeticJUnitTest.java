...
class ArithmeticJUnitTest {
    ...
    @ParameterizedTest // will be executed with the different values of i parameter
    @ValueSource(ints = {-9,-15,-8,7,3}) // value source specifies the values that will be tested
    void testPositiveIsNegative (int i) {assertTrue(Arithmetic.isNegative(i)); // assertTrue checks for isNeg output to be true
    }
