...
public class BasketballGame extends Game {
    ...
    /**
     * Int used to track current quarter / half in basketball
     */
    ...
    /**
     * Scoring Methods for Basketball
     */
     ...
     */
    public BasketballGame(String teamOne, String teamTwo) {
    ...
    public void addScore(int choice,int team) {
        ...
        // ADD for TEAM One
        if(team == 1){
            int newScore = getTeamOneScore() + addMe;
            this.setTeamOneScore(newScore);
        }
        // ADD for TEAM TWO
        else if(team == 2){
            int newScore = getTeamTwoScore() + addMe;
